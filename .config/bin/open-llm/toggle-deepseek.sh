#!/bin/bash
LAUNCH_COMMAND="/opt/google/chrome/google-chrome --profile-directory=Default --app-id=hmjcdonmhijmnefklekckjkeoknbiipb"

# Change these values:
APP_NAME="Deepseek"
WINDOW_CLASS="crx_hmjcdonmhijmnefklekckjkeoknbiipb.Google-chrome"
