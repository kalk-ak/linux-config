...
# --- Configuration ---
# The command to launch your Chrome PWA.
LAUNCH_COMMAND="/opt/google/chrome/google-chrome --profile-directory=Default --app-id=caidcmannjgahlnbpmidmiecjcoiiigg"

# The unique window class for your app. Find this using `wmctrl -lx`.
WINDOW_CLASS="crx_caidcmannjgahlnbpmidmiecjcoiiigg.Google-chrome"

# A user-friendly name for messages.
APP_NAME="Gemini"
