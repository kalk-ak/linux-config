#!/bin/bash
LAUNCH_COMMAND="/opt/google/chrome/google-chrome --profile-directory=Default --app-id=fmpnliohjhemenmnlpbfagaolkdacoja"

# Change these values:
APP_NAME="Claude"
WINDOW_CLASS="crx_fmpnliohjhemenmnlpbfagaolkdacoja.Google-chrome"
