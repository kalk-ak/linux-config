#!/bin/bash
LAUNCH_COMMAND="/opt/google/chrome/google-chrome --profile-directory=Default --app-id=cadlkienfkclaiaibeoongdcgmdikeeg"


# Change these values:
APP_NAME="ChatGPT"
WINDOW_CLASS="crx_cadlkienfkclaiaibeoongdcgmdikeeg.Google-chrome"
