#!/bin/bash
LAUNCH_COMMAND="/opt/google/chrome/google-chrome --profile-directory=Default --app-id=ndcgbfkpgjikkelfgnlckjognnoojgke"


# Change these values:
APP_NAME="Meta-AI"
WINDOW_CLASS="crx_ndcgbfkpgjikkelfgnlckjognnoojgke.Google-chrome"
